...
tax_result = {
    (u'igic_IC_compras_13_5_bc', u'IGIC 13,5% Intracomunitario. Bienes corrientes'): {
        ('in', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {},
            'tax': Decimal('0.00')
    ...
    (u'igic_IC_compras_13_5_bi', u'IGIC 13,5% Intracomunitario. Bienes de inversi\xf3n'): {
        ('in', 'credit'): {
            'base': Decimal('-100.00'), 
            'codes': {},
            'tax': Decimal('0.00')
    ...
    (u'igic_IC_compras_3_bc', u'IGIC 3% Intracomunitario. Bienes corrientes'): {
        ('in', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {},
            'tax': Decimal('0.00')
    ...
    (u'igic_IC_compras_3_bi',
     u'IGIC 3% Intracomunitario. Bienes de inversi\xf3n'): {
        ('in', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {},
            'tax': Decimal('0.00')
    ...
    (u'igic_IC_compras_7_bc',
     u'IGIC 7% Intracomunitario. Bienes corrientes'): {
        ('in', 'credit'): {
            'base': Decimal('-100.00'),
             'codes': {},
            'tax': Decimal('0.00')
    ...
    (u'igic_IC_compras_7_bi',
     u'IGIC 7% Intracomunitario. Bienes de inversi\xf3n'): {
         ('in', 'credit'): {
            ...
            'tax': Decimal('0.00')}},
    (u'igic_IC_compras_9_5_bc',
     u'IGIC 9,5% Intracomunitario. Bienes corrientes'): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'), 'codes': {
                 },
            'tax': Decimal('0.00')}, ('in', 'invoice'
            ...
            'tax': Decimal('0.00')}},
    (u'igic_IC_compras_9_5_bi',
     u'IGIC 9,5% Intracomunitario. Bienes de inversi\xf3n'): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'), 'codes': {
                 },
            'tax': Decimal('0.00')}, ('in', 'invoice'
            ...
            'tax': Decimal('0.00')}},
    (u'igic_IO', u'IGIC 0% Intracomunitario'): {
        ('out', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'base_intra_42_igic': (
                    u'Entregas Intracomunitarias IGIC', (
                        'credit_base_amount',
                        Decimal('-100.00')
                        )
                    )
    ...
    (u'igic_X0_compras_bc', u'IGIC 0% Importaciones bienes corrientes'): {
         ('in', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'igic_ded_26_00': (
                    u'Base importaciones bienes corrientes IGIC (0%)', (
                        'credit_base_amount',
                        Decimal('-100.00')
                        )
                    ),
                u'igic_ded_27_00': (
                    u'Cuotas devengadas importaciones bienes corrientes IGIC (0%)', (
                        'credit_tax_amount',
                        -0.0
                        )
                    )
    ...
    (u'igic_X0_compras_bi', u'IGIC 0% Importaciones bienes de inversi\xf3n'): {
         ('in', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'igic_ded_28_00': (
                    u'Base importaciones bienes inversi\xf3n IGIC (0%)', (
                        'credit_base_amount',
                        Decimal('-100.00')
                        )
                    ),
                u'igic_ded_29_00': (
                    u'Cuotas devengadas importaciones bienes inversi\xf3n IGIC (0%)', (
                        'credit_tax_amount',
                        -0.0
                        )
                    )
    ...
    (u'igic_X13_5_compras_bc', u'IGIC 13,5% Importaciones bienes corrientes'): {
         ('in', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'igic_ded_26_13_5': (
                    u'Base importaciones bienes corrientes IGIC (13%)', (
                        'credit_base_amount',
                        Decimal('-100.00')
                        )
                    ),
                ...
                u'igic_ded_27_13_5': (
                    u'Cuotas devengadas importaciones bienes corrientes IGIC (13,5%)', (
                        'credit_tax_amount',
                        -13.5
                        )
                    )
        ...
        ('in', 'invoice'): {
            ...
            'codes': {
                ...
                u'igic_ded_27_13_5': (
                    u'Cuotas devengadas importaciones bienes corrientes IGIC (13,5%)', (
                        'invoice_tax_amount', 13.5)
                    )
                },
            'tax': 13.5,
            }
        },
    (u'igic_X13_5_compras_bi', u'IGIC 13,5% Importaciones bienes de inversi\xf3n'): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
            'codes': {
                 u'igic_ded_28_13_5': (u'Base importaciones bienes inversi\xf3n IGIC (13,5%)'
            , ('credit_base_amount', Decimal('-100.00'))),
            u'igic_ded_29_13_5': (u'Cuotas devengadas importaciones bienes inversi\xf3n IGIC (13,5%)'
            , ('credit_tax_amount', -13.5))}, 'tax': -13.5},
        ('in', 'invoice'): {
            'base': Decimal('100.00'),
            'codes': {
                u'igic_ded_28_13_5': (
                    u'Base importaciones bienes inversi\xf3n IGIC (13,5%)', (
                        'invoice_base_amount',
                        Decimal('100.00')
                        )
                    ),
                u'igic_ded_29_13_5': (
                    u'Cuotas devengadas importaciones bienes inversi\xf3n IGIC (13,5%)', (
                        'invoice_tax_amount',
                        13.5
                        )
                    )
    ...
    (u'igic_X3_compras_bc', u'IGIC 3% Importaciones bienes corrientes'
     ): {
         ('in', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                 u'igic_ded_26_03': (
                     u'Base importaciones bienes corrientes IGIC (3%)', (
                         'credit_base_amount',
                         Decimal('-100.00')
                         )
                     ),
                 u'igic_ded_27_03': (
                     u'Cuotas devengadas importaciones bienes corrientes IGIC (3%)', (
                         'credit_tax_amount',
                         -3.0
                         )
                     )
    ...
    (u'igic_X3_compras_bi',
     u'IGIC 3% Importaciones bienes de inversi\xf3n'): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
            'codes': {
                 u'igic_ded_28_03': (u'Base importaciones bienes inversi\xf3n IGIC (3%)'
            , ('credit_base_amount', Decimal('-100.00'))),
            u'igic_ded_29_03': (u'Cuotas devengadas importaciones bienes inversi\xf3n IGIC (3%)'
            , ('credit_tax_amount', -3.0))}, 'tax': -3.0}, ('in',
            'invoice'): {
             'base': Decimal('100.00'),
            'codes': {
                 u'igic_ded_28_03': (u'Base importaciones bienes inversi\xf3n IGIC (3%)'
            ...
            u'igic_ded_29_03': (u'Cuotas devengadas importaciones bienes inversi\xf3n IGIC (3%)'
            , ('invoice_tax_amount', 3.0))}, 'tax': 3.0}},
    (u'igic_X7_compras_bc', u'IGIC 7% Importaciones bienes corrientes'
     ): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
         'codes': {
                 u'igic_ded_26_07': (u'Base importaciones bienes corrientes IGIC (7%)'
         , ('credit_base_amount', Decimal('-100.00'))),
    ...
    (u'igic_X7_compras_bi',
     u'IGIC 7% Importaciones bienes de inversi\xf3n'): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
            'codes': {
                 u'igic_ded_28_07': (u'Base importaciones bienes inversi\xf3n IGIC (7%)'
            , ('credit_base_amount', Decimal('-100.00'))),
            ...
            u'igic_ded_29_07': (u'Cuotas devengadas importaciones bienes inversi\xf3n IGIC (7%)'
            , ('invoice_tax_amount', 7.0))}, 'tax': 7.0}},
    (u'igic_X9_5_compras_bc',
     u'IGIC 9,5% Importaciones bienes corrientes'): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
            'codes': {
                 u'igic_ded_26_09_5': (u'Base importaciones bienes corrientes IGIC (9,5%)'
            , ('credit_base_amount', Decimal('-100.00'))),
            u'igic_ded_27_09_5': (u'Cuotas devengadas importaciones bienes corrientes IGIC (9,5%)'
            , ('credit_tax_amount', -9.5))}, 'tax': -9.5}, ('in',
            'invoice'): {
             'base': Decimal('100.00'),
            'codes': {
                 u'igic_ded_26_09_5': (u'Base importaciones bienes corrientes IGIC (9,5%)'
            , ('invoice_base_amount', Decimal('100.00'))),
            u'igic_ded_27_09_5': (u'Cuotas devengadas importaciones bienes corrientes IGIC (9,5%)'
            , ('invoice_tax_amount', 9.5))}, 'tax': 9.5}},
    (u'igic_X9_5_compras_bi',
     u'IGIC 9,5% Importaciones bienes de inversi\xf3n'): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
             'codes': {
                 u'igic_ded_28_09_5': (
                     u'Base importaciones bienes inversi\xf3n IGIC (9,5%)', (
                         'credit_base_amount',
                         Decimal('-100.00')
                         )
                     ),
                 u'igic_ded_29_09_5': (
                     u'Cuotas devengadas importaciones bienes inversi\xf3n IGIC (9,5%)', (
                         'credit_tax_amount',
                         -9.5
                         )
                     )
...
#                    ),
#                u'igic_dev_00': (
#                    u'R\xe9gimen general IGIC Devengado. Base Imponible 0%', (
#                        'invoice_base_amount',
#                        Decimal('100.00')
#                        )
#                    ),
...
#            }
    ...
    (u'igic_rep_13_5', u'IGIC 13,5%'): {
        ('out', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'igic_dev_13_5': (u'R\xe9gimen general IGIC Devengado. Base Imponible 13,5%'
            , ('credit_base_amount', Decimal('-100.00'))),
            u'igic_dev_21_13_5': (u'R\xe9gimen general IGIC Devengado. Cuota 13,5%'
            , ('credit_tax_amount', -13.5))}, 'tax': -13.5}, ('out',
            'invoice'): {
            'base': Decimal('100.00'),
            'codes': {
                u'igic_dev_13_5': (u'R\xe9gimen general IGIC Devengado. Base Imponible 13,5%'
            , ('invoice_base_amount', Decimal('100.00'))),
            u'igic_dev_21_13_5': (u'R\xe9gimen general IGIC Devengado. Cuota 13,5%'
            , ('invoice_tax_amount', 13.5))}, 'tax': 13.5}},
    (u'igic_rep_3', u'IGIC 3%'): {
        ('out', 'credit'): {
            'base': Decimal('-100.00'),
                                  'codes': {
                u'igic_dev_03': (u'R\xe9gimen general IGIC Devengado. Base Imponible 3%'
                                  , ('credit_base_amount',
                                  Decimal('-100.00'))),
                                  u'igic_dev_21_03': (u'R\xe9gimen general IGIC Devengado. Cuota 3%'
                                  , ('credit_tax_amount', -3.0))},
                                  'tax': -3.0}, ('out', 'invoice'
                                  ): {
            'base': Decimal('100.00'),
                                  'codes': {
                u'igic_dev_03': (u'R\xe9gimen general IGIC Devengado. Base Imponible 3%'
                                  ...
                                  Decimal('100.00'))),
                                  u'igic_dev_21_03': (u'R\xe9gimen general IGIC Devengado. Cuota 3%'
                                  , ('invoice_tax_amount', 3.0))},
                                  'tax': 3.0}},
    (u'igic_rep_7', u'IGIC 7%'): {
        ('out', 'credit'): {
            'base': Decimal('-100.00'),
                                  'codes': {
                u'igic_dev_07': (u'R\xe9gimen general IGIC Devengado. Base Imponible 7%'
                                  , ('credit_base_amount',
                                  Decimal('-100.00'))),
            ...
            'base': Decimal('100.00'),
                ...
                u'igic_dev_07': (u'R\xe9gimen general IGIC Devengado. Base Imponible 7%'
                                  ...
                                  'tax': 7.0}},
    (u'igic_rep_9_5', u'IGIC 9,5%'): {
        ('out', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'igic_dev_09_5': (u'R\xe9gimen general IGIC Devengado. Base Imponible 9,5'
            , ('credit_base_amount', Decimal('-100.00'))),
            u'igic_dev_21_09_5': (u'R\xe9gimen general IGIC Devengado. Cuota 9,5%'
            , ('credit_tax_amount', -9.5))}, 'tax': -9.5}, ('out',
            'invoice'): {
            'base': Decimal('100.00'),
            'codes': {
                u'igic_dev_09_5': (u'R\xe9gimen general IGIC Devengado. Base Imponible 9,5'
            ...
            u'igic_dev_21_09_5': (u'R\xe9gimen general IGIC Devengado. Cuota 9,5%'
            , ('invoice_tax_amount', 9.5))}, 'tax': 9.5}},
    (u'igic_sop_0', u'0% IGIC Soportado (operaciones corrientes)'
     ): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
         'codes': {
                 u'igic_ded_22_00': (u'Base operaciones interiores corrientes IGIC (0%)'
    ...
    (u'igic_sop_0_inv', u'0% IGIC Soportado (bienes de inversi\xf3n)'
     ): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
         'codes': {
                 u'igic_ded_24_00': (u'Base operaciones interiores bienes inversi\xf3n IGIC (0%)'
         , ('credit_base_amount', Decimal('-100.00')))}, 'tax': -0.0},
         ('in', 'invoice'): {
             'base': Decimal('100.00'),
         'codes': {
                 u'igic_ded_24_00': (u'Base operaciones interiores bienes inversi\xf3n IGIC (0%)'
         , ('invoice_base_amount', Decimal('100.00')))}, 'tax': 0.0}},
    (u'igic_sop_13_5', u'13,5% IGIC Soportado (operaciones corrientes)'
     ): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
         'codes': {
                 u'igic_ded_22_13_5': (u'Base operaciones interiores corrientes IGIC (13,5%)'
         , ('credit_base_amount', Decimal('-100.00'))),
         u'igic_ded_23_13_5': (u'Cuotas soportadas operaciones interiores corrientes IGIC (13,5%)'
         , ('credit_tax_amount', -13.5))}, 'tax': -13.5}, ('in',
         'invoice'): {
             'base': Decimal('100.00'),
         'codes': {
                 u'igic_ded_22_13_5': (u'Base operaciones interiores corrientes IGIC (13,5%)'
         ...
         , ('invoice_tax_amount', 13.5))}, 'tax': 13.5}},
    (u'igic_sop_13_5_inv',
     u'13,5% IGIC Soportado (bienes de inversi\xf3n)'): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
            'codes': {
                 u'igic_ded_24_13_5': (u'Base operaciones interiores bienes inversi\xf3n IGIC (13,5%)'
            , ('credit_base_amount', Decimal('-100.00'))),
            ...
            u'igic_ded_25_13_5': (u'Cuotas soportadas operaciones interiores bienes inversi\xf3n IGIC (13,5%)'
            , ('invoice_tax_amount', 13.5))}, 'tax': 13.5}},
    (u'igic_sop_3', u'3% IGIC Soportado (operaciones corrientes)'
     ): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
         'codes': {
                 u'igic_ded_22_03': (u'Base operaciones interiores corrientes IGIC (3%)'
         , ('credit_base_amount', Decimal('-100.00'))),
         ...
         u'igic_ded_23_03': (u'Cuotas soportadas operaciones interiores corrientes IGIC (3%)'
         , ('invoice_tax_amount', 3.0))}, 'tax': 3.0}},
    (u'igic_sop_3_inv', u'3% IGIC Soportado (bienes de inversi\xf3n)'
     ): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
         'codes': {
                 u'igic_ded_24_03': (u'Base operaciones interiores bienes inversi\xf3n IGIC (3%)'
         , ('credit_base_amount', Decimal('-100.00'))),
         ...
         u'igic_ded_25_03': (u'Cuotas soportadas operaciones interiores bienes inversi\xf3n IGIC (3%)'
         , ('invoice_tax_amount', 3.0))}, 'tax': 3.0}},
    (u'igic_sop_7', u'7% IGIC Soportado (operaciones corrientes)'
     ): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
         'codes': {
                 u'igic_ded_22_07': (u'Base operaciones interiores corrientes IGIC (7%)'
         , ('credit_base_amount', Decimal('-100.00'))),
         ...
         u'igic_ded_23_07': (u'Cuotas soportadas operaciones interiores corrientes IGIC (7%)'
         , ('invoice_tax_amount', 7.0))}, 'tax': 7.0}},
    (u'igic_sop_7_inv', u'7% IGIC Soportado (bienes de inversi\xf3n)'
     ): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
         'codes': {
                 u'igic_ded_24_07': (u'Base operaciones interiores bienes inversi\xf3n IGIC (7%)'
         , ('credit_base_amount', Decimal('-100.00'))),
         ...
         u'igic_ded_25_07': (u'Cuotas soportadas operaciones interiores bienes inversi\xf3n IGIC (7%)'
         , ('invoice_tax_amount', 7.0))}, 'tax': 7.0}},
    (u'igic_sop_9_5', u'9,5% IGIC Soportado (operaciones corrientes)'
     ): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
         'codes': {
                 u'igic_ded_22_09_5': (u'Base operaciones interiores corrientes IGIC (9,5%)'
         , ('credit_base_amount', Decimal('-100.00'))),
         ...
         , ('invoice_tax_amount', 9.5))}, 'tax': 9.5}},
    (u'igic_sop_9_5_inv',
     u'9,5% IGIC Soportado (bienes de inversi\xf3n)'): {
         ('in', 'credit'): {
             'base': Decimal('-100.00'),
             'codes': {
                 u'igic_ded_24_09_5': (
                     u'Base operaciones interiores bienes inversi\xf3n IGIC (9,5%)', (
                         'credit_base_amount',
                         Decimal('-100.00')
                         )
                     ),
                 u'igic_ded_25_09_5': (
                     u'Cuotas soportadas operaciones interiores bienes inversi\xf3n IGIC (9,5%)', (
                         'credit_tax_amount',
                         -9.5,
                         )
                     )
...
#             }
    ...
    (u'iva_rep_10_recc', u'IVA Criterio Caja 10%'): {
        ('out', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'recc_base_dev_10': (
                    u'R\xe9gimen especial criterio de Caja. Base devengada 10%', (
                        'credit_base_amount',
                        Decimal('-100.00')
                        )
                    ),
                u'recc_dev_10': (
                    u'R\xe9gimen especial criterio de Caja. IVA Devengado 10%', (
                        'credit_tax_amount',
                        -10.0
                        )
                    )
        ...
        ('out', 'invoice'): {
            'base': Decimal('100.00'),
                ...
                u'iva_dev_07_21': (u'R\xe9gimen general IVA Devengado. Base Imponible 21%'
                                  ...
                                  'tax': 21.0}},
    (u'iva_rep_21_recc', u'IVA Criterio Caja 21%'): {
        ('out', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'recc_base_dev_21': (
                    u'R\xe9gimen especial criterio de Caja. Base devengada 21%', (
                        'credit_base_amount',
                        Decimal('-100.00')
                        )
                    ),
                u'recc_dev_21': (
                    u'R\xe9gimen especial criterio de Caja. IVA Devengado 21%', (
                        'credit_tax_amount',
                        -21.0
                        )
                    )
    ...
    (u'iva_rep_4_recc', u'IVA Criterio Caja 4%'): {
        ('out', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'recc_base_dev_04': (u'R\xe9gimen especial criterio de Caja. Base devengada 4%'
            , ('credit_base_amount', Decimal('-100.00'))),
            u'recc_dev_04': (u'R\xe9gimen especial criterio de Caja. IVA Devengado 4%'
            , ('credit_tax_amount', -4.0))}, 'tax': -4.0}, ('out',
            'invoice'): {
            'base': Decimal('100.00'),
            'codes': {
                u'recc_base_dev_04': (u'R\xe9gimen especial criterio de Caja. Base devengada 4%'
    ...
    (u'iva_sop_10_inv', u'10% IVA Soportado (bienes de inversi\xf3n)'
         ...
         u'iva_ded_25_10': (u'Cuotas soportadas operaciones interiores bienes inversi\xf3n (10%)'
         , ('invoice_tax_amount', 10.0))}, 'tax': 10.0}},
    (u'iva_sop_10_recc', u'10% IVA Soportado criterio de caja'): {
        ('in' , 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'recc_base_ded_10': (u'R\xe9gimen especial criterio de Caja. Base Deduible 10%'
            , ('credit_base_amount', Decimal('-100.00'))),
    ...
    (u'iva_sop_21_inv', u'21% IVA Soportado (bienes de inversi\xf3n)'
         ...
         u'iva_ded_25_21': (u'Cuotas soportadas operaciones interiores bienes inversi\xf3n (21%)'
         , ('invoice_tax_amount', 21.0))}, 'tax': 21.0}},
    (u'iva_sop_21_recc', u'21% IVA Soportado criterio de caja'): {
        ('in' , 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'recc_base_ded_21': (u'R\xe9gimen especial criterio de Caja. Base Deduible 21%'
            , ('credit_base_amount', Decimal('-100.00'))),
    ...
    (u'iva_sop_4_inv', u'4% IVA Soportado (bienes de inversi\xf3n)'
         ...
         u'iva_ded_25_4': (u'Cuotas soportadas operaciones interiores bienes inversi\xf3n (4%)'
         , ('invoice_tax_amount', 4.0))}, 'tax': 4.0}},
    (u'iva_sop_4_recc', u'4% IVA Soportado criterio de caja'): {
        ('in', 'credit'): {
            'base': Decimal('-100.00'),
            'codes': {
                u'recc_base_ded_04': (u'R\xe9gimen especial criterio de Caja. Base Deduible 4%'
            , ('credit_base_amount', Decimal('-100.00'))),
